...
type ProposeConfigParser struct {
	rawAction *RawAction
}

func (c *ProposeConfigParser) ParseInput(input string) error {
	param := &proposal_manager.ProposeConfigParam{}
...
func (c *ProposeConfigParser) ParseAssertion(input string) error {
	return nil
}
