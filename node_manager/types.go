...
func (m *AllValidators) Decode(payload []byte) error {
	...
	if err := utils.UnpackOutputs(ABI, base.MethodGetAllValidators, &data, payload); err != nil {
		return err
	}
...
func (m *Validator) Decode(payload []byte) error {
	...
	if err := utils.UnpackOutputs(ABI, base.MethodGetValidator, &data, payload); err != nil {
		return err
	}
...
func (m *GlobalConfig) Decode(payload []byte) error {
	...
	if err := utils.UnpackOutputs(ABI, base.MethodGetGlobalConfig, &data, payload); err != nil {
		return err
	}
...
func (m *StakeInfo) Decode(payload []byte) error {
	...
	if err := utils.UnpackOutputs(ABI, base.MethodGetStakeInfo, &data, payload); err != nil {
		return err
	}
...
func (m *UnlockingInfo) Decode(payload []byte) error {
	...
	if err := utils.UnpackOutputs(ABI, base.MethodGetUnlockingInfo, &data, payload); err != nil {
		return err
	}
...
func (m *EpochInfo) Decode(payload []byte) error {
	...
	if err := utils.UnpackOutputs(ABI, base.MethodGetCurrentEpochInfo, &data, payload); err != nil {
		return err
	}
...
func (m *AccumulatedCommission) Decode(payload []byte) error {
	...
	if err := utils.UnpackOutputs(ABI, base.MethodGetAccumulatedCommission, &data, payload); err != nil {
		return err
	}
...
func (m *ValidatorAccumulatedRewards) Decode(payload []byte) error {
	...
	if err := utils.UnpackOutputs(ABI, base.MethodGetValidatorAccumulatedRewards, &data, payload); err != nil {
		return err
	}
...
func (m *ValidatorOutstandingRewards) Decode(payload []byte) error {
	...
	if err := utils.UnpackOutputs(ABI, base.MethodGetValidatorOutstandingRewards, &data, payload); err != nil {
		return err
	}
...
func (m *OutstandingRewards) Decode(payload []byte) error {
	...
	if err := utils.UnpackOutputs(ABI, base.MethodGetOutstandingRewards, &data, payload); err != nil {
		return err
	}
...
func (m *StakeRewards) Decode(payload []byte) error {
	...
	if err := utils.UnpackOutputs(ABI, base.MethodGetStakeRewards, &data, payload); err != nil {
		return err
	}
...
func (m *ValidatorSnapshotRewards) Decode(payload []byte) error {
	...
	if err := utils.UnpackOutputs(ABI, base.MethodGetValidatorSnapshotRewards, &data, payload); err != nil {
		return err
	}
...
func (m *StakeStartingInfo) Decode(payload []byte) error {
	...
	if err := utils.UnpackOutputs(ABI, base.MethodGetStakeStartingInfo, &data, payload); err != nil {
		return err
	}
...
func (m *CommunityInfo) Decode(payload []byte) error {
	...
	if err := utils.UnpackOutputs(ABI, base.MethodGetCommunityInfo, &data, payload); err != nil {
		return err
	}
...
func (m *TotalPool) Decode(payload []byte) error {
	...
	if err := utils.UnpackOutputs(ABI, base.MethodGetTotalPool, &data, payload); err != nil {
		return err
	}
